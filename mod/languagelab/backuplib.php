<?php //$Id: backuplib.php,v 1.4 2006/01/13 03:45:30 mjollnir_ Exp $
    ...
    function languagelab_backup_one_mod($bf,$preferences,$languagelab) {
        ...
        fwrite ($bf,full_tag("VIDEO",4,false,$languagelab->video));
        fwrite ($bf,full_tag("USE_GRADE_BOOK",4,false,$languagelab->use_grade_book));
        fwrite ($bf,full_tag("GROUPTYPE",4,false,$languagelab->grouptype));
        fwrite ($bf,full_tag("MASTER_TRACK",4,false,$languagelab->master_track));
